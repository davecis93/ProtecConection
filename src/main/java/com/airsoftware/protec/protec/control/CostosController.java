...
public class CostosController {
    ...
    public ResponseEntity<CostosDTO> obtenerCostos(@RequestBody GetCostosDTO getCostosDTO){
    ...
    public ResponseEntity<CostosDTO> asignarCostos(@RequestBody CostosDTO costosDTO){
        return ResponseEntity
                .status(HttpStatus.OK)
